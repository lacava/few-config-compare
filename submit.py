...
def main():
    ...
    reg_problems = args.reg_problems.split(',')
    clf_problems = args.clf_problems.split(',')
    ...
    save_file = results_path + 'FEW-config-compare-' + '-'.join(flags) + '.csv'
    print('save_file:',save_file)
    # write header
    with open(save_file,'w') as out:
        out.write('dataset\tmethod\ttrial\tparameters\tscore\ttime\n')
